...
import 'package:flutter_taxi_user/Components/select_address_view.dart';
import 'package:flutter_taxi_user/Model/map_type_model.dart';
import 'package:flutter_taxi_user/Model/place_model.dart';
import 'package:flutter_taxi_user/Screen/Menu/menu_screen.dart';
import 'package:flutter_taxi_user/Screen/SearchAddress/search_address_screen.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  BitmapDescriptor myIcon1,myIcon2;
...
//    _initCurrentLocation();
    ...
    BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(48, 48)), 'assets/image/marker/car_top_48.png')
        .then((onValue) {
      myIcon1 = onValue;
    });
    BitmapDescriptor.fromAssetImage(
        ImageConfiguration(size: Size(96, 96)), 'assets/image/marker/car_top_96.png')
        .then((onValue) {
      myIcon1 = onValue;
    });
  }
  ...
  void _onMapCreated(GoogleMapController controller) async {
    ...
    Marker marker = Marker(
      ...
      position: position,
      draggable: false,
      icon: checkPlatform ? myIcon1:myIcon2,
    );
    setState(() {
